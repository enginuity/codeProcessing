...
# Output to file
writeLines(shortdoc, con = "metacode/zGEN_shortdoc.txt")
writeLines(longdoc, con = "metacode/zGEN_longdoc.txt")
writeLines(functiondoc, con = "metacode/zGEN_funcdoc.txt")
